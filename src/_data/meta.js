...
export const author = {
  name: 'Nilushan Silva', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'nilushan.silva@gmail.com', // i.e. hola@lenesaile.com - email of the author
  website: 'https://nilushan.silva.info', // i.e. https.://www.lenesaile.com - the personal site of the author
...
export const creator = {
  name: 'Nilushan Silva', // i.e. Lene Saile - creator's (developer) name.
  email: 'nilushan.silva@gmail.com',
  website: 'https://nilushan.silva.info',
  social: ''
};
...
export const blog = {
  // RSS feed
  name: 'My Full Stack Development Blog',
